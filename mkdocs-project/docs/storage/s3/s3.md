...
S3 is useful for publishing public static websites and other content, for example to create a content delivery network
...
It is often desirable to add authentication to a website to ensure that only
...
* See:  [CloudFront](../../cdn/cloudfront/cloudfront.md)
